                ...
                if (type) {
                    ...
                    switch(type) {
                        ...
                        case 'number':
                            ...
                            break;
                        case 'datepicker':
                            elementOptions.input = '<div class="input-group w-md">';
                            elementOptions.input += '<input type="text" name="{{ data.name }}" ng-model="data.value"  class="form-control '+ elementOptions.inputClass +'" style="'+  elementOptions.inputStyle +'" '+ elementOptions.inputAttr +' value="{{ data.value }}" datepicker-popup="{{format}}" ng-model="dt" is-open="opened" datepicker-options="dateOptions" ng-required="true" close-text="Close" />';
                            elementOptions.input += '<span class="input-group-btn">';
                            elementOptions.input += '<button type="button" class="btn btn-default" ng-click="open($event)"><i class="glyphicon glyphicon-calendar"></i></button>';
                            elementOptions.input += '</span>';
                            elementOptions.input += '</div>';
                            break;
                        case 'textarea':
                        ...
                        case 'image-upload':
                            ...
                            break;
                        case 'new-editor':
                            elementOptions.input = ['<div lazy-load="textAngular" style="'+  elementOptions.inputStyle +'" '+ elementOptions.inputAttr +' class="'+ elementOptions.inputClass +'"><div text-angular ng-model="data.value" class="btn-groups"></div></div>'].join('\n');
                            break;
                        case 'text-editor':
                            elementOptions.input = [
                                                '<div class="btn-toolbar m-b-sm btn-editor" data-role="editor-toolbar" data-target="#editor">',
                                                    ...
                                                    '</div>',
                                                    //'<div>',
                                                    //'<button type="button" class="btn btn-default ng-scope" name="html" unselectable="on" ng-disabled="isDisabled()" tabindex="-1" ng-click="executeAction()" ng-class="displayActiveToolClass(active)" title="Toggle html / Rich Text" aria-disabled="false">Toggle HTML</button>',
                                                    //'</div>',
                                                    '<div class="btn-group">',
