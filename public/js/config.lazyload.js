...
angular.module('app')
  ...
  .constant('JQ_CONFIG', {
      ...
      ckeditor:       [   appHelper.bowerComponents('../js/ckeditor/ckeditor.js'),
                          appHelper.bowerComponents('angular-ckeditor/angular-ckeditor.min.js')],
      ...
      $ocLazyLoadProvider.config({
          ...
          modules: [
              ...
              },
              {
                  name: 'ckeditor',
                  files: [ 
                      appHelper.bowerComponents('../js/ckeditor/ckeditor.js'),
                      appHelper.bowerComponents('angular-ckeditor/angular-ckeditor.min.js')
                  ]
              },
              {
