...
class IndexController extends ControllerBase
{
    ...
    public function indexAction()
    {
        ...
        $this->assets
                ...
                ->addJs('/bower_components/angular-ckeditor/angular-ckeditor.min.js')
        ...
        $this->assets
                ...
                ->addJs('/js/controllers/mails.js')
                ->addJs('/js/controllers/banners.js')
                ->addJs('/js/controllers/contacts.js')
                ->addJs('/js/controllers/products.js')
                ->addJs('/js/controllers/faqs.js')
                ->addJs('/js/controllers/product-categories.js')
                ->addJs('/js/controllers/categories.js')
                ->addJs('/js/controllers/pages.js')
                ->addJs('/js/controllers/settings.js')
                ->setSourcePath(PUBLIC_PATH)
